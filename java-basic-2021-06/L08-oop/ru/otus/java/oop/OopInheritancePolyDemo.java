...
public class OopInheritancePolyDemo {
    public static void main(String[] args) {
        ...
        //otus.java.oop.Animal someAnimal = new otus.java.oop.Animal();

        System.out.println("=== otus.java.oop.Dog");
        Dog dog = new Dog("Бобик");
        System.out.println(dog.getName());
        dog.guard();

        System.out.println("=== otus.java.oop.Cat");
        Cat cat = new Cat();
...
//        checkGuard(cat);
    ...
    // Чем плохо?
//    private static void talkWithAnimal(otus.java.oop.Dog dog) { }
//    private static void talkWithAnimal(otus.java.oop.Cat cat) { }
