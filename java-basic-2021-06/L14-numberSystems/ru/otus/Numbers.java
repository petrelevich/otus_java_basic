...
public class Numbers {
    ...
    private static void bitwiseOperations() {
        ...
        System.out.println("negVal shiftLeft:" + Long.toBinaryString(negVal << 20));
        System.out.println("negVal shiftRight     :" + Long.toBinaryString(negVal >> 20));

        //беззнакоый сдвиг
        System.out.println("negVal shiftRight Sign:" + Long.toBinaryString(negVal >>> 20));
        System.out.println("posVal shiftRight Sign:" + Long.toBinaryString(x2 >>> 1));
    }
