...
import ru.otus.solution3_srp.step03.services.EquationEvaluationResultHistoryHolder;
import ru.otus.solution3_srp.step03.services.EquationEvaluator;
import ru.otus.solution3_srp.step03.services.EquationParser;
...
public class Main {
    ...
    private static void handleEquationCommand(ConsoleIOService ioService, String equationStr, EquationEvaluationResultHistoryHolder historyHolder) {
        ...
        ru.otus.solution3_srp.step03.domain.Equation equation = equationParser.parseEquation(equationStr);
        if (equation == null) {
